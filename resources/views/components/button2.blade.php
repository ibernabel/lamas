...
@php
    $variantClasses = [
        ...
        'secondary' => 'bg-gray-600 dark:bg-gray-500 hover:bg-gray-700 dark:hover:bg-gray-600 focus:ring-gray-500 dark:focus:ring-gray-400 text-white',
        ...
        'warning' => 'bg-yellow-600 dark:bg-yellow-500 hover:bg-yellow-700 dark:hover:bg-yellow-600 focus:ring-yellow-500 dark:focus:ring-yellow-400 text-black',
        ...
        'light' => 'bg-gray-50 dark:bg-gray-600 hover:bg-gray-100 dark:hover:bg-gray-600 focus:ring-gray-200 dark:focus:ring-gray-400 text-gray-600 dark:text-gray-200 border border-gray-200 dark:border-gray-600',
