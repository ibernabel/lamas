                            ...
                            <x-input-group>
                                ...
                                <x-select id="housing_possession_type"
                                    ...
                                    <option value="owned"
                                        ...
                                        {{ __('Owned') }}</option>
                                    <option value="rented"
                                        {{ old('customer.details.housing_possession_type', $loanApplication->customer->details->housing_possession_type) == 'rented' ? 'selected' : '' }}>
                                        {{ __('Rented') }}</option>
                                    <option value="mortgaged"
                                        {{ old('customer.details.housing_possession_type', $loanApplication->customer->details->housing_possession_type) == 'mortgaged' ? 'selected' : '' }}>
                                        {{ __('Mortgaged') }}</option>
                                    <option value="other"
                                        {{ old('customer.details.housing_possession_type', $loanApplication->customer->details->housing_possession_type) == 'other' ? 'selected' : '' }}>
                                        {{ __('Other') }}</option>
                                </x-select>
