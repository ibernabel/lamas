                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <x-input-group>
                                ...
                                <x-select id="housing_type" name="customer[details][housing_type]">
                                    ...
                                    <option value="owned"
                                        {{ old('customer.details.housing_type', $customer->details?->housing_type) == 'owned' ? 'selected' : '' }}>
                                        {{-- Use $customer --}}
                                        {{ __('Owned') }}</option>
                                    <option value="rented"
                                        {{ old('customer.details.housing_type', $customer->details?->housing_type) == 'rented' ? 'selected' : '' }}>
                                        {{-- Use $customer --}}
                                        {{ __('Rented') }}</option>
                                    <option value="mortgaged"
                                        {{ old('customer.details.housing_type', $customer->details?->housing_type) == 'mortgaged' ? 'selected' : '' }}>
                                        {{-- Use $customer --}}
                                        {{ __('Mortgaged') }}</option>
                                    <option value="other"
                                        {{ old('customer.details.housing_type', $customer->details?->housing_type) == 'other' ? 'selected' : '' }}>
                                        {{-- Use $customer --}}
                                        {{ __('Other') }}</option>
                                </x-select>
