    ...
    <div class="max-w-5xl mx-auto py-6 sm:px-6 lg:px-8">
        <form action="{{ route('customers.update', $customer) }}" method="POST"> {{-- Changed Route and Variable --}}
            ...
            <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <x-input-group>
                                ...
                                <x-input2 id="first_name" type="text" name="customer[details][first_name]"
                                    value="{{ old('customer.details.first_name', $customer->details?->first_name) }}" /> {{-- Use $customer --}}
                            ...
                            <x-input-group>
                                ...
                                <x-input2 id="last_name" type="text" name="customer[details][last_name]"
                                    value="{{ old('customer.details.last_name', $customer->details?->last_name) }}" /> {{-- Use $customer --}}
                            ...
                            <x-input-group>
                                ...
                                <x-input2 id="birthday" type="date" name="customer[details][birthday]"
                                    value="{{ old('customer.details.birthday', $customer->details?->birthday) }}" /> {{-- Use $customer --}}
                            ...
                            <x-input-group>
                                ...
                                <x-input2 id="cellular" type="tel" name="customer[details][phones][0][number]"
                                    value="{{ old('customer.details.phones.0.number', $customer->details?->phones->where('type', 'mobile')->first()?->number ?? '') }}" /> {{-- Use $customer, adjusted logic --}}
                            ...
                            <x-input-group>
                                ...
                                <x-input2 id="home_phone" type="tel" name="customer[details][phones][1][number]"
                                    value="{{ old('customer.details.phones.1.number', $customer->details?->phones->where('type', 'home')->first()?->number ?? '') }}" /> {{-- Use $customer, adjusted logic --}}
                            ...
                            <x-input-group>
                                ...
                                <x-input2 id="email" type="email" name="customer[details][email]"
                                    value="{{ old('customer.details.email', $customer->details?->email) }}" /> {{-- Use $customer --}}
                            ...
                            <x-input-group>
                                ...
                                <x-select id="marital_status" name="customer[details][marital_status]">
                                    ...
                                    <option value="single"
                                        {{ old('customer.details.marital_status', $customer->details?->marital_status) == 'single' ? 'selected' : '' }}> {{-- Use $customer --}}
                                        {{ __('Single') }}</option>
                                    <option value="married"
                                        {{ old('customer.details.marital_status', $customer->details?->marital_status) == 'married' ? 'selected' : '' }}> {{-- Use $customer --}}
                                        {{ __('Married') }}</option>
                                    <option value="divorced"
                                        {{ old('customer.details.marital_status', $customer->details?->marital_status) == 'divorced' ? 'selected' : '' }}> {{-- Use $customer --}}
                                        {{ __('Divorced') }}</option>
                                    <option value="widowed"
                                        {{ old('customer.details.marital_status', $customer->details?->marital_status) == 'widowed' ? 'selected' : '' }}> {{-- Use $customer --}}
                                        {{ __('Widowed') }}</option>
                                    <option value="other"
                                        {{ old('customer.details.marital_status', $customer->details?->marital_status) == 'other' ? 'selected' : '' }}> {{-- Use $customer --}}
                                        {{ __('Other') }}</option>
                                </x-select>
                            ...
                            <x-input-group>
                                ...
                                <x-input2 id="nationality" type="text" name="customer[details][nationality]"
                                    value="{{ old('customer.details.nationality', $customer->details?->nationality) }}" /> {{-- Use $customer --}}
                            ...
                            <x-input-group>
                                ...
                                <x-select id="gender" name="customer[details][gender]">
                                    ...
                                    <option value="male"
                                        {{ old('customer.details.gender', $customer->details?->gender) == 'male' ? 'selected' : '' }}> {{-- Use $customer --}}
                                        {{ __('Male') }}</option>
                                    <option value="female"
                                        {{ old('customer.details.gender', $customer->details?->gender) == 'female' ? 'selected' : '' }}> {{-- Use $customer --}}
                                        {{ __('Female') }}</option>
                                </x-select>
                            ...
                            <x-input-group>
                                ...
                                <x-select id="education_level" name="customer[details][education_level]">
                                    ...
                                    <option value="primary"
                                        {{ old('customer.details.education_level', $customer->details?->education_level) == 'primary' ? 'selected' : '' }}> {{-- Use $customer --}}
                                        {{ __('Primary') }}</option>
                                    <option value="secondary"
                                        {{ old('customer.details.education_level', $customer->details?->education_level) == 'secondary' ? 'selected' : '' }}> {{-- Use $customer --}}
                                        {{ __('Secondary') }}</option>
                                    <option value="high_school"
                                        {{ old('customer.details.education_level', $customer->details?->education_level) == 'high_school' ? 'selected' : '' }}> {{-- Use $customer --}}
                                        {{ __('High School') }}</option>
                                    <option value="bachelor"
                                        {{ old('customer.details.education_level', $customer->details?->education_level) == 'bachelor' ? 'selected' : '' }}> {{-- Use $customer --}}
                                        {{ __('Bachelor') }}</option>
                                    <option value="postgraduate"
                                        {{ old('customer.details.education_level', $customer->details?->education_level) == 'postgraduate' ? 'selected' : '' }}> {{-- Use $customer --}}
                                        {{ __('Postgraduate') }}</option>
                                    <option value="master"
                                        {{ old('customer.details.education_level', $customer->details?->education_level) == 'master' ? 'selected' : '' }}> {{-- Use $customer --}}
                                        {{ __('Master') }}</option>
                                    <option value="doctorate"
                                        {{ old('customer.details.education_level', $customer->details?->education_level) == 'doctorate' ? 'selected' : '' }}> {{-- Use $customer --}}
                                        {{ __('Doctorate') }}</option>
                                    <option value="other"
                                        {{ old('customer.details.education_level', $customer->details?->education_level) == 'other' ? 'selected' : '' }}> {{-- Use $customer --}}
                                        {{ __('Other') }}</option>
                                </x-select>
                            ...
                            <x-input-group>
                                ...
                                <x-input2 id="street" type="text"
                                    ...
                                    value="{{ old('customer.details.addresses.0.street', $customer->details?->addresses?->first()?->street ?? '') }}" /> {{-- Use $customer --}}
                            ...
                            <x-input-group>
                                ...
                                <x-input2 id="street2" type="text"
                                    ...
                                    value="{{ old('customer.details.addresses.0.street2', $customer->details?->addresses?->first()?->street2 ?? '') }}" /> {{-- Use $customer --}}
                            ...
                            <x-input-group>
                                ...
                                <x-input2 id="city" type="text" name="customer[details][addresses][0][city]"
                                    value="{{ old('customer.details.addresses.0.city', $customer->details?->addresses?->first()?->city ?? '') }}" /> {{-- Use $customer --}}
                            ...
                            <x-input-group>
                                ...
                                <x-input2 id="state" type="text" name="customer[details][addresses][0][state]"
                                    value="{{ old('customer.details.addresses.0.state', $customer->details?->addresses?->first()?->state ?? '') }}" /> {{-- Use $customer --}}
                            ...
                            <x-input-group>
                                ...
                                <x-select id="housing_type" name="customer[details][housing_type]">
                                    ...
                                    <option value="owned"
                                        {{ old('customer.details.housing_type', $customer->details?->housing_type) == 'owned' ? 'selected' : '' }}> {{-- Use $customer --}}
                                        {{ __('Owned') }}</option>
                                    <option value="rented"
                                        {{ old('customer.details.housing_type', $customer->details?->housing_type) == 'rented' ? 'selected' : '' }}> {{-- Use $customer --}}
                                        {{ __('Rented') }}</option>
                                    <option value="mortgaged"
                                        {{ old('customer.details.housing_type', $customer->details?->housing_type) == 'mortgaged' ? 'selected' : '' }}> {{-- Use $customer --}}
                                        {{ __('Mortgaged') }}</option>
                                    <option value="other"
                                        {{ old('customer.details.housing_type', $customer->details?->housing_type) == 'other' ? 'selected' : '' }}> {{-- Use $customer --}}
                                        {{ __('Other') }}</option>
                                </x-select>
                            ...
                            <x-input-group>
                                <x-label for="move_in_date" value="{{ __('Move in date') }}" /> {{-- Changed label id --}}
                                <x-input2 id="move_in_date" type="date" name="customer[details][move_in_date]"
                                    value="{{ old('customer.details.move_in_date', $customer->details?->move_in_date ?? '') }}" /> {{-- Use $customer --}}
                            ...
                            <x-input-group>
                                ...
                                <x-select id="vehicle_type" name="customer[vehicle][vehicle_type]">
                                    <option value="">{{ __('Select') }}</option>
                                    <option value="owned"
                                        {{ old('customer.vehicle.vehicle_type', $customer->vehicle?->vehicle_type ?? '') == 'owned' ? 'selected' : '' }}> {{-- Use $customer --}}
                                        {{ __('Owned') }}</option>
                                    <option value="rented"
                                        {{ old('customer.vehicle.vehicle_type', $customer->vehicle?->vehicle_type ?? '') == 'rented' ? 'selected' : '' }}> {{-- Use $customer --}}
                                        {{ __('Rented') }}</option>
                                    <option value="financed"
                                        {{ old('customer.vehicle.vehicle_type', $customer->vehicle?->vehicle_type ?? '') == 'financed' ? 'selected' : '' }}> {{-- Use $customer --}}
                                        {{ __('Financed') }}</option>
                                    <option value="borrowed"
                                        {{ old('customer.vehicle.vehicle_type', $customer->vehicle?->vehicle_type ?? '') == 'borrowed' ? 'selected' : '' }}> {{-- Use $customer --}}
                                        {{ __('Borrowed') }}</option>
                                    <option value="none"
                                        {{ old('customer.vehicle.vehicle_type', $customer->vehicle?->vehicle_type ?? '') == 'none' ? 'selected' : '' }}> {{-- Use $customer --}}
                                        {{ __('None') }}</option>
                                    <option value="other"
                                        {{ old('customer.vehicle.vehicle_type', $customer->vehicle?->vehicle_type ?? '') == 'other' ? 'selected' : '' }}> {{-- Use $customer --}}
                                        {{ __('Other') }}</option>
                                </x-select>
                            ...
                            <x-input-group>
                                ...
                                <x-input2 id="vehicle_brand" type="text" name="customer[vehicle][vehicle_brand]"
                                    value="{{ old('customer.vehicle.vehicle_brand', $customer->vehicle?->vehicle_brand ?? '') }}" /> {{-- Use $customer --}}
                            ...
                            <x-input-group>
                                ...
                                <x-input2 id="vehicle_model" type="text" name="customer[vehicle][vehicle_model]"
                                    value="{{ old('customer.vehicle.vehicle_model', $customer->vehicle?->vehicle_model ?? '') }}" /> {{-- Use $customer --}}
                            ...
                            <x-input-group>
                                ...
                                <x-input2 id="vehicle_year" type="number" min="1900" max="{{ date('Y') }}"
                                    ...
                                    value="{{ old('customer.vehicle.vehicle_year', $customer->vehicle?->vehicle_year ?? '') }}" /> {{-- Use $customer --}}
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <x-input-group>
                                ...
                                <x-select id="is_self_employed" name="customer[jobInfo][is_self_employed]">
                                    <option value="">{{ __('Select') }}</option>
                                    <option value="1"
                                        {{ old('customer.jobInfo.is_self_employed', $customer->jobInfo?->is_self_employed) == 1 ? 'selected' : '' }}> {{-- Use $customer --}}
                                        {{ __('Yes') }}</option>
                                    <option value="0"
                                        {{ old('customer.jobInfo.is_self_employed', $customer->jobInfo?->is_self_employed) == 0 ? 'selected' : '' }}> {{-- Use $customer --}}
                                        {{ __('No') }}</option>
                                </x-select>
                            ...
                            <x-input-group>
                                ...
                                <x-input2 id="company_name" type="text" name="customer[company][name]"
                                    value="{{ old('customer.company.name', $customer->company?->name) }}" /> {{-- Use $customer --}}
                            ...
                            <x-input-group>
                                ...
                                <x-input2 id="company_phone" type="tel"
                                    ...
                                    value="{{ old('customer.company.phones.0.number', $customer->company?->phones->where('type', 'work')->first()?->number ?? '') }}" /> {{-- Use $customer, adjusted logic --}}
                            ...
                            <x-input-group>
                                ...
                                <x-input2 id="company_address" type="text"
                                    ...
                                    value="{{ old('customer.company.addresses.0.street', $customer->company?->addresses->where('type', 'work')->first()?->street ?? '') }}" /> {{-- Use $customer, adjusted logic --}}
                            ...
                            <x-input-group>
                                ...
                                <x-input2 id="role" type="text" name="customer[jobInfo][role]"
                                    value="{{ old('customer.jobInfo.role', $customer->jobInfo?->role) }}" /> {{-- Use $customer --}}
                                <x-input-error for="customer.jobInfo.role" />
                            </x-input-group>
                            <x-input-group>
                                <x-label for="start_date" value="{{ __('Start Date') }}" />
                                <x-input2 id="start_date" type="date" name="customer[jobInfo][start_date]"
                                    value="{{ old('customer.jobInfo.start_date', $customer->jobInfo?->start_date) }}" /> {{-- Use $customer --}}
                            ...
                            <x-input-group>
                                ...
                                <x-input2 id="salary" type="number" step="0.01"
                                    ...
                                    value="{{ old('customer.jobInfo.salary', $customer->jobInfo?->salary) }}" /> {{-- Use $customer --}}
                            ...
                            <x-input-group>
                                ...
                                <x-select id="payment_type" name="customer[jobInfo][payment_type]">
                                    <option value="">{{ __('Select') }}</option>
                                    <option value="cash"
                                        {{ old('customer.jobInfo.payment_type', $customer->jobInfo?->payment_type) == 'cash' ? 'selected' : '' }}> {{-- Use $customer --}}
                                        {{ __('Cash') }}</option>
                                    <option value="bank_transfer"
                                        {{ old('customer.jobInfo.payment_type', $customer->jobInfo?->payment_type) == 'bank_transfer' ? 'selected' : '' }}> {{-- Use $customer --}}
                            ...
                            <x-input-group>
                                ...
                                <x-select id="payment_frequency" name="customer[jobInfo][payment_frequency]">
                                    <option value="">{{ __('Select') }}</option>
                                    <option value="weekly"
                                        {{ old('customer.jobInfo.payment_frequency', $customer->jobInfo?->payment_frequency) == 'weekly' ? 'selected' : '' }}> {{-- Use $customer --}}
                                        {{ __('Weekly') }}</option>
                                    <option value="biweekly"
                                        {{ old('customer.jobInfo.payment_frequency', $customer->jobInfo?->payment_frequency) == 'biweekly' ? 'selected' : '' }}> {{-- Use $customer --}}
                                        {{ __('Biweekly') }}</option>
                                    <option value="monthly"
                                        {{ old('customer.jobInfo.payment_frequency', $customer->jobInfo?->payment_frequency) == 'monthly' ? 'selected' : '' }}> {{-- Use $customer --}}
                                        {{ __('Monthly') }}</option>
                                </x-select>
                            ...
                            <x-input-group>
                                ...
                                <x-input2 id="payment_bank" type="text" name="customer[jobInfo][payment_bank]"
                                    value="{{ old('customer.jobInfo.payment_bank', $customer->jobInfo?->payment_bank) }}" /> {{-- Use $customer --}}
                            ...
                            <x-input-group>
                                ...
                                <x-input2 id="other_incomes" type="text" name="customer[jobInfo][other_incomes]"
                                    value="{{ old('customer.jobInfo.other_incomes', $customer->jobInfo?->other_incomes) }}" /> {{-- Use $customer --}}
                            ...
                            <x-input-group>
                                ...
                                <x-input2 id="other_incomes_source" type="text"
                                    ...
                                    value="{{ old('customer.jobInfo.other_incomes_source', $customer->jobInfo?->other_incomes_source) }}" /> {{-- Use $customer --}}
                            ...
                            <x-input-group>
                                ...
                                <x-input2 id="schedule" type="text" name="customer[jobInfo][schedule]"
                                    value="{{ old('customer.jobInfo.schedule', $customer->jobInfo?->schedule) }}" /> {{-- Use $customer --}}
                            ...
                            <x-input-group>
                                ...
                                <x-input2 id="supervisor_name" type="text"
                                    ...
                                    value="{{ old('customer.jobInfo.supervisor_name', $customer->jobInfo?->supervisor_name) }}" /> {{-- Use $customer --}}
                ...
                <x-card>
                    @forelse ($customer->references ?? [] as $reference) {{-- Use $customer --}}
                        <x-card.content class="border-b last:border-b-0"> {{-- Added border for separation --}}
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <x-input-group>
                                    <x-label for="reference_name_{{ $loop->index }}" value="{{ __('Name') }}" />
                                ...
                                <x-input-group>
                                    <x-label for="reference_occupation_{{ $loop->index }}" value="{{ __('Occupation') }}" />
                                ...
                                <x-input-group>
                                    <x-label for="reference_relationship_{{ $loop->index }}" value="{{ __('Relationship') }}" />
            ...
            <div class="sticky bottom-0 bg-white border-t border-gray-200 p-2 flex justify-end space-x-4 my-2">
                ...
                <x-button2 type="submit" variant="success">
                    {{ __('Update Customer') }} {{-- Changed Button Text --}}
                </x-button2>
            </div>
        </form>
    </div> {{-- End max-w-5xl --}}
